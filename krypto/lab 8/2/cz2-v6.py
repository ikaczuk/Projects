...
# Definicje alfabetu i listy numerycznej
...
print('\nOdtworzone (ciąg znaków):', recovered)

# Konwertowanie odzyskanego sekretu z powrotem na wartości numeryczne
recovered_numbers = int_to_numbers(recovered, len(numerical_representation))
recovered_text = numbers_to_string(recovered_numbers, alphabet, numerical)

print("Odzyskane wartości numeryczne:", recovered_numbers)
print("Odzyskany tekst:", recovered_text)