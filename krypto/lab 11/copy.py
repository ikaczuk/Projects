...
print(f"\nBalance of miner's wallet: {ernesto_coin.get_balance_of_address('miner-address')}")
...
print(f"\nBalance of miner's wallet after second mining: {ernesto_coin.get_balance_of_address('miner-address')}")